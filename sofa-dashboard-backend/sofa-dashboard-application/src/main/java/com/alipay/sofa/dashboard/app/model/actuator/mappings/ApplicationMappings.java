...
/**
 * A model copy of {@link org.springframework.boot.actuate.web.mappings.MappingsEndpoint.ApplicationMappings}
 * A description of an application's request mappings. Primarily intended for
 * serialization to JSON.
 */
public class ApplicationMappings implements Serializable {

    private static final int                   serialVersionUID = 0x11;

    private final Map<String, ContextMappings> contexts         = new HashMap<>();
